...
import { checkSetupNeeded, markSetupDone, runFullSetup, getVenvPythonExe, ensureSslPatch, getDevApiVenvPythonExe } from './python-setup'
...
function runExtensionSetup(
  ...
  return new Promise((resolve, reject) => {
    ...
    const pythonExe = getDevApiVenvPythonExe() ?? getVenvPythonExe(userData)
